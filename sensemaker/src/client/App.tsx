...
import { ListingList, ObservationCreate, ObservationList, ObservationShow, RevisionList, RevisionShow } from './components';
    ...
    <div className="admin-shell">
      ...
      <section className="admin-card">
        <Admin dataProvider={dataProvider} theme={theme} error={AdminError} disableTelemetry>
          <Resource name="observations" list={ObservationList} show={ObservationShow} create={ObservationCreate} />
          <Resource name="revisions" list={RevisionList} show={RevisionShow} />
